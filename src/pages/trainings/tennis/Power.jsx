...
const initialExercises = [
  {
    name: 'Força de Pernas e Core',
    key: 'pernas',
    description: 'Fortalece a base do corpo para impulsos e deslocamentos explosivos.',
  },
  {
    name: 'Exercícios Pliométricos',
    key: 'pliometria',
    description: 'Desenvolve explosão muscular e agilidade com movimentos rápidos.',
  },
  {
    name: 'Membro Superior com Pesos',
    key: 'superior',
    description: 'Foco nos braços e tronco para golpes mais potentes.',
  },
  {
    name: 'Estabilidade e Controle',
    key: 'estabilidade',
    description: 'Aprimora equilíbrio e controle corporal durante os movimentos.',
  },
];
...
export default function Power() {
  ...
  const handleClick = async (key) => {
    ...
    try {
      const module = await import(`../../../data/power/${key}.js`);
    ...
    <div className="min-h-screen bg-zinc-900 font-montserrat p-6 flex justify-center items-start">
      ...
      >
        ...
        <p className="mb-10 text-zinc-300 leading-relaxed italic">
          Este treino foca no <span className="text-yellow-400 font-semibold">fortalecimento muscular</span> para golpes mais{' '}
          <span className="text-yellow-400 font-semibold">potentes</span> e{' '}
          <span className="text-yellow-400 font-semibold">explosivos</span>.
        </p>
